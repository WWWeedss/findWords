<template>
  <div class="h-[calc(100vh-100px)] flex flex-col">
    ...
    <div class="mt-3 flex items-center gap-2">
      <input v-model="custom" type="text" placeholder="说说看你想怎么回……"
             class="flex-1 border border-gray-300 rounded-md px-3 py-2 outline-none focus:ring-2 focus:ring-green-300"/>
      <button class="px-3 py-2 rounded-md bg-green-500 text-white hover:opacity-90" @click="appendCustom">发送</button>
    </div>
  </div>
</template>
